...
if __name__ == "__main__":
    base_model_list = ['efficientnet-b4', 'tu-efficientnetv2_rw_m', 'tu-tf_efficientnetv2_l']
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet_e_10_bs_16/train/patch/image/', help='patched stage2 prdiction image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet_e_10_bs_16/train/patch/mask/', help='patched stage2 prdiction mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet_e_10_bs_16/test/', help='stage2 prdiction image test dir')
