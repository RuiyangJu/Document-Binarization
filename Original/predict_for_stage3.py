...
from Base.tool_clean import get_image_patch_deep, get_image_patch, check_is_image
...
# make directory
image_save_path = './Unet/predicted_image_for_stage3_dibco_Unet_e_10_bs_16'
...
for img in images:
    ...
    # save stage2 merged color train image
